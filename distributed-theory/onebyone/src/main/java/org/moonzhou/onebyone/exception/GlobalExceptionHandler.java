...
import org.moonzhou.onebyone.core.ErrorCode.*;
import jakarta.servlet.http.HttpServletRequest;
import lombok.extern.slf4j.Slf4j;
import org.moonzhou.onebyone.core.ResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseDTO<?> handleBindException(BindException e) {
        ...
        return ResponseDTO.fail(Client.COMMON_REQUEST_PARAMETERS_INVALID, message);
    }
